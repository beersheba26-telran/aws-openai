...
DYNAMODB_CONVERSATIONS_TABLE = getenv("DYNAMODB_CONVERSATIONS_TABLE", "rag-agent-conversations")
DYNAMODB_MESSAGES_TABLE = getenv("DYNAMODB_MESSAGES_TABLE", "rag-agent-messages")